class Ant < Formula
  ...
  url "https://www.apache.org/dyn/closer.cgi?filename=ant/binaries/apache-ant-1.10.5-bin.tar.xz&action=download", :using => :curl
  ...
  resource "ivy" do
    url "https://www.apache.org/dyn/closer.cgi?filename=ant/ivy/2.4.0/apache-ivy-2.4.0-bin.tar.gz&action=download", :using => :curl
    sha256 "7a3d13a80b69d71608191463dfc2a74fff8ef638ce0208e70d54d28ba9785ee9"
  end

  resource "bcel" do
    url "https://www.apache.org/dyn/closer.cgi?filename=commons/bcel/binaries/bcel-6.2-bin.tar.gz&action=download", :using => :curl
